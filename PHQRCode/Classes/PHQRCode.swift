...
//  App
//
//  Created by MIAO on 2021/4/9.
//

import UIKit
import AVFoundation

public class PHQRCode: NSObject,AVCaptureMetadataOutputObjectsDelegate {
    ...
    public var maxDetectedCount: Int
...
//        dataOutput.setMetadataObjectsDelegate(self, queue: DispatchQueue.main)
    ...
    func createPath(_ points: NSArray) -> UIBezierPath {
        ...
        var point : CGPoint = points[0] as! CGPoint
        path.move(to: point)
